...
describe('# AuthController', () => {
    describe('## login method', () => {
        it('Scenario 1', async () => {
            const request = { body: { phoneNumber: '083028431141', password: '*gxh)a*vcgirqegnjlc&mfi' } }
            const ret = {}
        ...
        it('Scenario 2', async () => {
            const request = { body: { phoneNumber: '089833513022', password: '*u_c^@o#djxe!b@lsnomzee$' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.login(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"Incorrect phone number or password!","error":"incorrect-phonenumber-or-password"}})
        ...
        it('Scenario 4', async () => {
            const request = { body: { phoneNumber: '085227348186', password: 'c$z%zx@iol(mq@' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.login(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"Incorrect phone number or password!","error":"incorrect-phonenumber-or-password"}})
        ...
        it('Scenario 5', async () => {
            const request = { body: { phoneNumber: '085200178467', password: 'opv^srosztx!klt' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.login(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"OTP sent successfully!","error":null}})
        })
        it('Scenario 6', async () => {
            const request = { body: { phoneNumber: '083008460868', password: 'nmg)h*x$e(vtvimgfmaz%u' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.login(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"Incorrect phone number or password!","error":"incorrect-phonenumber-or-password"}})
        ...
        it('Scenario 7', async () => {
            const request = { body: { phoneNumber: '087580887997', password: '+j)*jakuv(ellf' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.login(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"Incorrect phone number or password!","error":"incorrect-phonenumber-or-password"}})
    ...
    describe('## verify method', () => {
        it('Scenario 1', async () => {
            const request = { body: { phoneNumber: '089833513022', smsotp: '125336' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { body: { phoneNumber: '084541894816', smsotp: '128909' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.verify(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { body: { phoneNumber: '087580887998', smsotp: '126723' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.verify(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { body: { phoneNumber: '083028431141', smsotp: '678901' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.verify(request, response)
    ...
    describe('## resetPassword method', () => {
        it('Scenario 1', async () => {
            const request = { body: { phoneNumber: '084772392608', isVerified: false, password: '+j)*jakuv(ellf' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { body: { phoneNumber: '087839925893', isVerified: false, password: 'qyumambcy@' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.resetPassword(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { body: { phoneNumber: '083500141420', isVerified: false, password: '*u_c^@o#djxe!b@lsnomzee$' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.resetPassword(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { body: { phoneNumber: '087824627503', isVerified: false, password: 'c$z%zx@iol(mq@' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await AuthController.resetPassword(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
