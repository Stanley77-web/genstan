...
describe('# RetailerController', () => {
    ...
    describe('## addCart method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { product: { productId: 'ProductCommercialID-008', productType: 'Monitor', status: 'distributing', quantity: 80, price: 8000 } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { product: { productCommercialId: 'ProductCommercialID-006', productType: 'Earphone', status: 'distributing', quantity: 60, price: 6000 } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await RetailerController.addCart(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { product: { productId: 'ProductCommercialID-003', productType: 'Tablet', status: 'manufactured', quantity: 30, price: 3000 } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await RetailerController.addCart(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { user: {  }, body: { product: { productCommercialId: 'ProductCommercialID-004', productType: 'Smartwatch', status: 'exported', quantity: 40, price: 4000 } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await RetailerController.addCart(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## deteleProductInCart method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { product: { productCommercialId: 'ProductCommercialID-008', productType: 'Monitor', status: 'distributing', quantity: 80, price: 8000 } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { product: { productCommercialId: 'ProductCommercialID-010', productType: 'Mouse', status: 'retailing', quantity: 100, price: 10000 } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await RetailerController.deteleProductInCart(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { product: { productId: 'ProductCommercialID-006', productType: 'Earphone', status: 'distributing', quantity: 60, price: 6000 } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await RetailerController.deteleProductInCart(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { user: {  }, body: { product: { productCommercialId: 'ProductCommercialID-001', productType: 'Laptop', status: 'manufactured', quantity: 10, price: 1000 } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await RetailerController.deteleProductInCart(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
