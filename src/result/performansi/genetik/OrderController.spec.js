...
describe('# OrderController', () => {
    describe('## getTransactionHistory method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, params: { orderId: 'OrderID-001' } }
            const ret = {}
    ...
    describe('## getAllOrdersByAddress method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, query: { address: 'East Street, No 3' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, query: { address: 'West Street, No 4' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await OrderController.getAllOrdersByAddress(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, query: { address: 'West Street, No 1' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await OrderController.getAllOrdersByAddress(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## getOrder method', () => {
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, params: { orderId: 'OrderID-017' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await OrderController.getOrder(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, params: { orderId: 'OrderID-020' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await OrderController.getOrder(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## createOrder method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { orderObj: { orderId: 'OrderID-001', orderDate: '29-06-2024', qrCode: null } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { orderObj: [{ orderId: 'OrderID-009', orderDate: '06-07-2024' }, { orderId: 'OrderID-019', orderDate: '06-07-2024' }] } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await OrderController.createOrder(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## updateOrder method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { orderObj: [{ orderId: 'OrderID-008', orderDate: '05-07-2024' }, { orderId: 'OrderID-018', orderDate: '05-07-2024' }] } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { orderObj: { orderId: 'OrderID-003', orderDate: '31-06-2024', qrCode: 'QRCode-003' } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await OrderController.updateOrder(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { orderObj: { orderId: 'OrderID-010', orderDate: '07-07-2024', qrCode: null } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await OrderController.updateOrder(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## finishOrder method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { orderObj: [{ orderId: 'OrderID-010', orderDate: '07-07-2024' }, { orderId: 'OrderID-020', orderDate: '07-07-2024' }] } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { orderObj: { orderId: 'OrderID-008', orderDate: '05-07-2024', qrCode: 'QRCode-008' } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await OrderController.finishOrder(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
