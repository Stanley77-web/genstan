...
describe('# ProductController', () => {
    describe('## getTransactionHistory method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, params: { productId: 'ProductID-006' } }
            const ret = {}
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, params: { productId: 'ProductID-015' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.getTransactionHistory(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"successfully","error":null}})
    ...
    describe('## getProduct method', () => {
        ...
        it('Scenario 2', async () => {
            const request = { params: { productId: 'ProductID-005' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.getProduct(request, response)
            expect(ret).toEqual({"json":{"data":{"productId":"ProductID-005","productType":"Headphone","status":"cultivated","quantity":50,"price":5000,"qrCode":"QrCode-005","expireTime":"03-08-2024","image":"Image-005"},"message":"successfully","error":null}})
        })
    })
    describe('## getTransactionsHistory method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, query: { productId: 'ProductID-018' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, query: { productId: 'ProductID-009' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.getTransactionsHistory(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"failed","error":"Cannot read properties of null (reading 'userId')"}})
    ...
    describe('## cultivateProduct method', () => {
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { productObj: { productId: 'ProductID-004', productType: 'Smartwatch', status: 'imported', quantity: 40, price: 4000, qrCode: 'QrCode-004', expireTime: '02-08-2024', image: 'Image-004' } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.cultivateProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"failed","error":"Cannot read properties of null (reading 'userCode')"}})
    ...
    describe('## harvestProduct method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-012' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-014' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.harvestProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-017' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.harvestProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-011' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.harvestProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 5', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-003' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.harvestProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## importProduct method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-010', price: 2000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-017', price: 10000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.importProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-003', price: 6000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.importProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-008', price: 8000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.importProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 5', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-009', price: 5000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.importProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## manufactureProduct method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-017', imageUrl: 'Image-006', expireTime: '08-08-2024' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-010', imageUrl: 'Image-004', expireTime: '07-08-2024' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.manufactureProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-018', imageUrl: 'Image-009', expireTime: '05-08-2024' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.manufactureProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-009', imageUrl: 'Image-001', expireTime: '30-07-2024' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.manufactureProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 5', async () => {
            const request = { user: {  }, body: { productId: 'ProductID-012', imageUrl: 'Image-007', expireTime: '29-07-2024' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.manufactureProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## updateProduct method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { productObj: { productId: 'ProductID-007', productType: 'Speaker', status: 'cultivated', quantity: 70, price: 7000, qrCode: 'QrCode-007', expireTime: '05-08-2024', image: 'Image-007' } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { productObj: { productId: 'ProductID-006', productType: 'Earphone', status: 'harvested', quantity: 60, price: 6000, qrCode: 'QrCode-006', expireTime: '04-08-2024', image: 'Image-006' } } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductController.updateProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
