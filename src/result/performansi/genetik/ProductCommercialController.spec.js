...
describe('# ProductCommercialController', () => {
    describe('## getTransactionHistory method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, params: { productCommercialId: 'ProductCommercialID-005' } }
            const ret = {}
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, params: { productCommercialId: 'ProductCommercialID-007' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.getTransactionHistory(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"successfully","error":null}})
    ...
    describe('## getProduct method', () => {
        ...
        it('Scenario 2', async () => {
            const request = { params: { productCommercialId: 'ProductCommercialID-001' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.getProduct(request, response)
            expect(ret).toEqual({"json":{"data":{"productId":"ProductCommercialID-001","productType":"Laptop","status":"manufactured","quantity":10,"price":1000},"message":"successfully","error":null}})
        })
    })
    describe('## exportProduct method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-001', price: 3000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-010', price: 10000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.exportProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-001', price: 5000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.exportProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-003', price: 7000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.exportProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 5', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-005', price: 2000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.exportProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## distributeProduct method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-008' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-003' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.distributeProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-010' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.distributeProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-011' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.distributeProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 5', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-001' } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.distributeProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## importRetailerProduct method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-005', price: 9000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-002', price: 4000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.importRetailerProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-006', price: 8000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.importRetailerProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-010', price: 7000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.importRetailerProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 5', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-011', price: 3000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.importRetailerProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
    ...
    describe('## sellProduct method', () => {
        it('Scenario 1', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-007', price: 4000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
        ...
        it('Scenario 2', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-009', price: 2000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.sellProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 3', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-005', price: 5000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.sellProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 4', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-008', price: 7000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.sellProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
        ...
        it('Scenario 5', async () => {
            const request = { user: {  }, body: { productId: 'ProductCommercialID-011', price: 8000 } }
            const ret = {}
            const response = { json: jest.fn(data => ret.json = data), status: jest.fn().mockReturnThis() }
            await ProductCommercialController.sellProduct(request, response)
            expect(ret).toEqual({"json":{"data":null,"message":"User not found!","error":"user-notfound"}})
